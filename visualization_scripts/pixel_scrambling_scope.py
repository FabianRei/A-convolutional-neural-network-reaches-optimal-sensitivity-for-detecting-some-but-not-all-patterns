...
'''
Visualize results, when the template has a centered quadratic part of the signal shuffled
'''
...
scope_folders = [f.path for f in
                 os.scandir(os.path.join(on_root_path(), 'local', 'experiment', 'different_shuffle_scope')) if
                 f.is_dir()]
